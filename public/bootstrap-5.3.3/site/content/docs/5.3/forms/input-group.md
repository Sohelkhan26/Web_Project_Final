...
layout: docs
title: Input group
description: Easily extend form.blade.php controls by adding text, buttons, or button groups on either side of textual inputs, custom selects, and custom file inputs.
group: forms
toc: true
---
