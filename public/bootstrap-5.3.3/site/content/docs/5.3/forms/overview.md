...
layout: docs
title: Forms
description: Examples and usage guidelines for form.blade.php control styles, layout options, and custom components for creating a wide variety of forms.
group: forms
toc: true
...
sections:
  ...
  - title: Floating labels
    description: Create beautifully simple form.blade.php labels that float over your input fields.
  - title: Layout
